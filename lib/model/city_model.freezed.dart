...
class _$CityModelTearOff {
  ...
  _CityModel call({String? group, String? id, String? name}) {
    return _CityModel(
      group: group,
      id: id,
      name: name,
...
abstract class $CityModelCopyWith<$Res> {
  ...
  $Res call({String? group, String? id, String? name});
}
...
class _$_CityModel implements _CityModel {
  _$_CityModel({this.group, this.id, this.name});
  ...
  @override
  String toString() {
    return 'CityModel(group: $group, id: $id, name: $name)';
  }
...
abstract class _CityModel implements CityModel {
  factory _CityModel({String? group, String? id, String? name}) = _$_CityModel;
